<html>
  <head>
	<title>your secuity is crap</title>
...
blink {
  -webkit-animation: 2s linear infinite blink_effect; /* for Safari 4.0 - 8.0 */
  animation: 0.3s linear infinite blink_effect;
  color: lightgray;
}
...
<body onLoad="animate()">
  ...
  var delay = 90; // <---- delay after each frame moving cat
